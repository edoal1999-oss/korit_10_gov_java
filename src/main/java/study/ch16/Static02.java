...
class UserRepository {
    ...
    public UserRepository(User[] users) {
       this.users = users; //의존성 주입, DI//의존성 주입 잘하는 걸 객체지향이라고 함.//추상화-다형성
    }
...
class UserService {
    private UserRepository userRepository = new UserRepository(new User[100]);

...
public class Wildcard {
    ...
    public static void print2(SuccessResponse<? extends Student> sr) { //Student 상속받은 것만 와일드 카드로 쓸 수 있음
        System.out.println(sr); //print2는 올라가는 것을 막음. 상한선을 정함. 상한 제한 와일드카드
    }

    public static void print3(SuccessResponse<? super Student> sr) { //super은 (여기에선) 부모쪽으로 방향틈을 의미.
        System.out.println(sr); //하한 제한 와일드카드
    }

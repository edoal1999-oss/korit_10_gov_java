...
public class Ex06 {
    static void main() {
        ...
        List<Student> studentList = List.of(
                Student.builder().name("노푸른").studentYear(1).korScore(80).engScore(90).mathScore(100).build(),
                Student.builder().name("노푸니").studentYear(2).korScore(70).engScore(80).mathScore(90).build(),
                Student.builder().name("노푸영").studentYear(1).korScore(90).engScore(80).mathScore(70).build(),
                Student.builder().name("노푸정").studentYear(2).korScore(60).engScore(70).mathScore(80).build()
        );
